...
public class DBField {
	...
	public DBField(String tableName, String fieldName, String fieldType, int fieldSize, String remarks) {
		super();
	...
	public String toString() {
		return "DBField [tableName=" + tableName + ", fieldName=" + fieldName + ", fieldType=" + fieldType
